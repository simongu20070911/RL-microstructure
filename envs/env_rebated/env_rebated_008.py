# -*- coding: utf-8 -*-
"""
HFT Environment with 0.008% Rebate (8 bps)

This environment extends the base HFT environment to simulate market maker rebates
of 0.008% (8 basis points). This rebate rate corresponds to the highest VIP tiers
on exchanges like Binance VIP 9 level.

Key changes from base environment:
- transaction_cost_long: -0.00008 (negative = rebate)
- transaction_cost_short: -0.00008 (negative = rebate)
"""
...
class HFTEnvRebated008(HFTEnv):
    """
    HFT Environment with 0.008% rebate for market making activities.
    ...
    def __init__(self, config):
        ...
        # Apply 0.008% rebate (8 bps) - negative transaction costs
        rebated_config["transaction_cost_long"] = -0.00008   # 8 bps rebate for buys
        rebated_config["transaction_cost_short"] = -0.00008  # 8 bps rebate for sells
        
        # Store rebate information for tracking
        self.rebate_rate = 0.00008
        self.rebate_bps = 8
...
def get_default_rebated_config_008():
    """
    Returns a default configuration for 0.008% rebated environment.
    ...
    config = {
        ...
        # Rebated Transaction Costs (8 bps rebate)
        "transaction_cost_long": -0.00008,   # 8 bps rebate for buys
        "transaction_cost_short": -0.00008,  # 8 bps rebate for sells
...
if __name__ == "__main__":
    ...
    print("Testing HFTEnvRebated008 Environment")

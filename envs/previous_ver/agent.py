...
def create_sac_agent(env, hidden_dim=256, features_dim=128, validation_start=0.8, device="auto", batch_size=256):
    """
    ...
    try:
        ...
        train_env = TimeSeriesEnvWrapper(train_env, None, episode_length=400)
        val_env = TimeSeriesEnvWrapper(val_env, None, episode_length=400)

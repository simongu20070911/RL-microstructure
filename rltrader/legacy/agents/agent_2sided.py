...
def create_test_env(env_config: dict, model: SAC, episode_length: int = 4000) -> gym.Env:
    ...
    try:
        ...
        from envs.env_2sided import HFTEnv # Adjust the import path as necessary!
    except ImportError:
...
if __name__ == '__main__':
    ...
    config = {
        ...
        "max_inventory": 5.0,
        "episode_length": 400,
        "env_path": "envs.env_2sided", # Adjust if needed
        "env_class": "HFTEnv",
    ...
    try:
        from envs.env_2sided import HFTEnv # Adjust import path if needed
    except ImportError:

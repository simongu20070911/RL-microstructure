...
for date in dates:
  agg_trade_orderbook.append(pd.read_csv(f'/home/gaen/Documents/billions/data/orderbooks/raw2/input_data/{date}/orderbook_agg_trade.csv'))
...
mean_dollar_vol = 600000

orderbook_clean_dollarvol_all = cleaner.group_book_by_dollarvol2(agg_trade_orderbook_all, cols_dict, mean_dollar_vol)


orderbook_clean_dollarvol_all.to_csv(f'/home/gaen/Documents/billions/data/orderbooks/raw2/input_data/all/orderbook_agg_trade_dollarvol_{mean_dollar_vol}.csv', index=False)

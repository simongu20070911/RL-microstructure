...
# Set working directory (important as requested)
import os
import sys
os.chdir('/home/gaen/Documents/codespace-gaen/Ts-master')
...
config = {
    ...
    "paths": {
        ...
        "local": {
            "agg_trade": {
                "train": "/home/gaen/Documents/billions/data/orderbooks/raw2/input_data/",
                "test": "/home/gaen/Documents/billions/data/orderbooks/raw2/input_data",
            },
            "orderbook": {
                "train": "./input_data/",
                "test": "./input_data/",
...
if __name__ == "__main__":
    ...
    date_train = 'initial_2_day'
    #date_train = 'all'
    # Example reading CSV
    agg_trade = pd.read_csv(
        #config["paths"]["local"]["agg_trade"]["train"] + date_train + "/orderbook_agg_trade_dollarvol_27000.csv"
